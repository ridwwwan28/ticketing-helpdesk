            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div>
                    ...
                    <input type="text" id="tgl-buat" name="tgl_buat"
                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                        value="{{ old('_tgl_buat', $ticket->no_tiket) }}">
                </div>
                <div>
                    <label for="nama-user" class="block text-sm font-medium mb-2">Tanggal Selesai</label>
                    <input type="text" id="nama-user" name="nama"
                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                        value="{{ old('nama', $ticket->username) }}">
                </div>
