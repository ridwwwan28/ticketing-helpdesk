        ...
        <table class="min-w-full divide-y divide-gray-200 hidden md:table">
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach ($tickets as $no => $ticket)
                    {{-- jika login role user, maka ticket yang muncul hanya sesuai ticket yang login --}}
                    @if (auth()->user()->role == 'user')
                        @if (auth()->user()->email == $ticket->username)
                                        ...
                                        @if ($ticket->ticket_status == 'IN PROCESS')
                                            <span
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 24 16" fill="none" stroke="currentColor"
                        ...
                        {{-- untuk role admin dan superadmin, muncul semua ticket --}}
                    @else
                        <tr class="odd:bg-white even:bg-gray-100 hover:bg-gray-100">
                            <td class="size-px whitespace-nowrap">
                                <div class="py-2 px-2">
    ...
    <div class="md:hidden space-y-4">
        @foreach ($tickets as $ticket)
            ...
            @if (auth()->user()->role == 'user')
                ...
                {{-- jika login role admin/superadmin, maka semua ticket muncul --}}
            @else
                <div class="odd:bg-white even:bg-gray-100 hover:bg-gray-100 m-1 p-4 border rounded shadow">
                    <div class="text-sm">
                        <div><strong>NO. TICKET :</strong> {{ $ticket->no_tiket }}</div>
